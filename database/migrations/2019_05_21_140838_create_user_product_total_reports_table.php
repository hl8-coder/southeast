...
class CreateUserProductTotalReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_product_total_reports', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['user_id', 'product_code'], 'user_product_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('user_product_total_reports');
    }
}
