...
class CreateGameBetHistoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('game_bet_history_details', function (Blueprint $table) {
            $table->increments('id')->comment('游戏记录主表');
    ...
    {
        Schema::dropIfExists('game_bet_history_details');
    }
}
