...
class CreateUserProductMonthlyReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_product_monthly_reports', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_product_monthly_reports');
    }
}
