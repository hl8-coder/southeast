...
class CreateUserPlatformMonthlyReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_platform_monthly_reports', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('date')->comment('所属日期');
    ...
    {
        Schema::dropIfExists('user_platform_monthly_reports');
    }
}
