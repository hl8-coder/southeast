...
class CreateUserPlatformTotalReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_platform_total_reports', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unique(['user_id', 'platform_code'], 'user_platform_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('user_platform_total_reports');
    }
}
