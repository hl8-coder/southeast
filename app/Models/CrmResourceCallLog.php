...
class CrmResourceCallLog extends Model
{
    public $fillable = ['crm_resource_id', 'admin_id', 'channel', 'call_status', 'purpose', 'prefer_product', 'prefer_bank', 'source', 'comment',];
    ...
    {
        return $this->belongsTo(CrmResource::class);
    }
    ...
    {
        return $query->whereHas('crmResource', function ($query) use ($fullName) {
    ...
    {
        return $query->whereHas('crmResource', function ($query) use ($phone) {
